<template>
  <sui-form>
    <sui-header dividing>Hasta Bilgileri</sui-header>
    <sui-form-field>
      ...
      <sui-form-fields fields="two">
        ...
        <sui-form-field>
          ...
          <date-dropdown min="1900" v-model="selectedDate" />
        </sui-form-field>
        <label>-</label>
      </sui-form-fields>
    </sui-form-field>
    ...
    <sui-header dividing>Hasta Yakını Bilgileri</sui-header>
    <sui-form-field>
      <sui-form-fields fields="two">
        <sui-form-field>
          <label>Kimlik Numarası</label>
    ...
    <div class="mt-10">
    <button class="btn btn-primary" @click="registerPatient()">Hastayı Kaydet</button>
    </div>
  </sui-form>
</template>
